...
sort-panel VISIT_TIMES,BY_DATA,ASC
ignore-panel HOSTS
ignore-panel KEYPHRASES

log-format %^?%C|%s|%x|%b|%^|%h|%R|%U|%v|%u|%^|%^
date-format %*
time-format %*
http-protocol no
http-method no
output /var/www/htdocs/logs/index.html
